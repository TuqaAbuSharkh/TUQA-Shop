...
namespace TUQA_Shop.Migrations
{
    ...
    [Migration("20250914192717_reviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TUQA_Shop.models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TUQA_Shop.models.Cart", b =>
                {
            ...
            modelBuilder.Entity("TUQA_Shop.models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("TUQA_Shop.models.PasswordResetCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TUQA_Shop.models.ReviewImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TUQA_Shop.models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TUQA_Shop.models.Cart", b =>
                {
                    ...
                    b.HasOne("TUQA_Shop.models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TUQA_Shop.models.OrderItem", b =>
                {
                    b.HasOne("TUQA_Shop.models.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("TUQA_Shop.models.ReviewImages", b =>
                {
                    b.HasOne("TUQA_Shop.models.Review", "Review")
